...
export class LogQuery {
  ...
  static createNewDiscussion(param: {
    userName: string;
    findingName: string;
    subprojectId: number
    ...
    return {
      data: {
        ...
        description: `<p><strong>${param.userName}'s</strong> created new discussion on ${param.findingName} <em><mark class=\"bg-sky-100 rounded-none px-0.5\">` +
